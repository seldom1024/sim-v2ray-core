...
// CryptionReader is a general purpose reader that
// applies block cipher on top of a regular reader
...
/**
Read reads blocks from underlying reader, the length of
blocks must be a multiply of BlockSize()
*/
